...
public class SpeechService extends Service {
     ...
     */
    public void startRecognizing(int sampleRate,String languageCode) {
        if (mApi == null) {
     ...
     */
    public void recognizeInputStream(InputStream stream,String languageCode) {
        try {
            mApi.recognize(
    ...
    private class AccessTokenTask extends AsyncTask<Void, Void, AccessToken> {
        ...
        protected AccessToken doInBackground(Void... voids) {
            ...
            // *******************
            final InputStream stream = getResources().openRawResource(R.raw.credential); // TODO replace file audio with credential.json
            try {
